...
import { Satisfication } from "../../component/Satisfication";
import { Segmentation } from "../../component/Segmentation";
import { TopCountries } from "../../component/TopCountries";
const employeeData = [
  {
    id: "1",
    name: "Esther Howard",
...
export function Content({ onSidebarHide }) {
  return (
