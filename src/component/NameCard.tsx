...
export function NameCard({ name, position, transactionAmount, rise, tasksCompleted, imgId }) {
      ...
      <div className="w-full p-2 lg:w-1/3">
        <div className="rounded-lg bg-card flex justify-between p-3 h-32">
          ...
          <div className="flex flex-col items-center">
            ...
            <animated.div className={clsx(rise ? "text-green-500" : "text-red-500", "font-bold", "text-lg")}>
