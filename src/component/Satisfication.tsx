    ...
    <div className="p-4 h-full">
      ...
      <div className="flex justify-center">
        <svg viewBox="0 0 700 380" fill="none" width="300" xmlns="http://www.w3.org/2000/svg" id="svg">
          ...
          <animated.circle
            cx={dashOffset.interpolate((x) => 350 + 250 * Math.cos(map(x, 785.4, 0, pi, tau)))}
            cy={dashOffset.interpolate((x) => 350 + 250 * Math.sin(map(x, 785.4, 0, pi, tau)))}
            r="12"
            fill="#fff"
          />
      ...
      <div className="flex justify-center">
        <div className="flex justify-between mt-2" style={{ width: "300px" }}>
          ...
          >
            <div className="font-bold" style={{ color: "#2f49d1", fontSize: "18px" }}>
              97.78%
            </div>
